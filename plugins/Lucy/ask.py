# SPECIAL THANKS TO @Codeflix_Bots @sewxiy @sd_bots FOR MODIFYING THESE AMAZING CODES 
...
async def ai_generate_private(client, message):
  buttons = [[
    InlineKeyboardButton("ᴜsᴇ ɪɴ ɢʀᴏᴜᴘ", url="https://t.me/+Vegv963Nf2kzYzBl")
  ]]
  reply_markup = InlineKeyboardMarkup(buttons)
  await message.reply_sticker("CAACAgUAAxkBAAECQNBmEPRJUuLrUDvpzQwsvs0KE1w5jgACcAQAAkdoOVaYU-q7wXAETB4E")
...
#- ᴄʀᴇᴅɪᴛ - Github - @Codeflix-bots , @sewxiy, @sd_bots
